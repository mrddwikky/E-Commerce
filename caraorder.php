...
<title>Maxi Boutique Online</title>
...
<br /></td>
    ...
    <th width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Produk">
      <tr>
        <th align="left" valign="top" class="Teks_Produk" scope="col">Ketentuan Order Barang !!!</th>
      </tr>
      <tr>
        <th align="left" valign="top" class="Teks_Produk" scope="col"><hr /></th>
      </tr>
      <tr>
        <td align="left" valign="top"><p class="Teks_Informasi">Cara berbelanja di MaxiBoutique sangat mudah. Bacalah petunjuk di bawah ini dan Anda siap untuk berbelanja :)</p>
          <p class="Teks_Informasi">Terlebih dahulu login, jika Anda belum mendaftar menjadi member silahkan klik Daftar member baru pada halaman pertama website ini.</p>
          <p class="Teks_Informasi">Klik pada tombol beli pada item yang ingin Anda beli, jika Anda sudah selesai memilih barang, klik “check out” 
            Selanjutnya, Halaman terakhir adalah untuk pengecekan mengenai informasi no faktur dan total harga barang yang And beli. Order Anda telah kami terima. Tunggu konfirmasi dari kami.</p>
          <p class="Teks_Informasi">Cara pembayaran dilakukan dengan sistem transfer melalui bank BCA, Mandiri atau Niaga. Nomor rekening akan kami beritahukan pada saat sms konfirmasi kami kirimkan.</p>
          <p class="Teks_Informasi">Barang dikirimkan dengan jasa pengiriman Tiki JNE, harga yang tercantum pada produk belum termasuk ongkos kirim.</p>
          <p class="Teks_Informasi">Jika anda ingin tanya-tanya, atau ada barang yang anda inginkan tetapi tidak ada di website ini, jangan sungkan untuk menghubungi kami.</p>
          <p class="Teks_Informasi">MAXI BOUTIQUE</p>
          <p class="Teks_Informasi">Selamat berbelanja!</p></td>
      </tr>
    </table></th>
