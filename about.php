...
<br /></td>
    ...
    <th width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Produk">
      ...
      <tr>
        <td align="left" valign="top"><p class="Teks_Informasi">Aku ada ide. Selama ini banyak toko yg menawarkan harga murah. Tapi kualitas meragukan.</p>
          <p class="Teks_Informasi">Coba bikin toko yg menawarkan harga mahal. Misalnya begini: </p>
          <p class="Teks_Informasi">Toko baju mahal. Kami menjual baju dengan harga mahal. Tidak ada harga murah di sini. Karena semuanya dibikin dengan sangat memperhatikan kualitas dan design yang menarik. Pelayanan juga otomatis memuaskan. </p>
          <p class="Teks_Informasi">Dengan membeli baju di sini, otomatis anda tergolong menjadi orang kaya yg memiliki high taste terrhadap baju berkualitas.</p>
          <p class="Teks_Informasi">Kami juga tidak akan menawarkan diskon. Karena barang diskon biasanya juga meragukan. </p>
          <p class="Teks_Informasi">Kami juga tidak menawarkan untuk memborong semua barang dagangan kami, karena barang kami kualitasnya inggi, jadi kami sarankan anda mikir matang matang dulu sebelum membeli.</p>
          <p class="Teks_Informasi">Salam mahal!</p></td>
      </tr>
    </table></th>
