  ...
  <tr>
    ...
    <th colspan="2" align="right" valign="middle" bgcolor="#F8FBE6" class="Teks_Menu_Atas" scope="col">
      <table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <th align="right" scope="col"><marquee scrollamount=”3”>Selamat datang di website kami, maxi boutique siap melayani keperluan Anda dengan harga terbaik, selamat berbelanja....&nbsp;
          </marquee></th>
        </tr>
      </table>
</th>
...
<br /></td>
    ...
    <th width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Produk">
      ...
      <tr>
        <th align="left" valign="top" class="Teks_Selamat" scope="col">Selamat datang di maxi boutique.<br />
